  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-primary text-white hover:shadow-glow transform hover:scale-105 font-semibold shadow-medium",
        premium: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-medium hover:shadow-large border border-accent/20",
        minimal: "bg-transparent border border-border hover:bg-muted/50 text-foreground hover:border-primary/50",
      },
      size: {
